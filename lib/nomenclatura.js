...
export function buildRows(ads, audMap, statusMap, tipoMap) {
  ...
  for (const a of ads) {
    ...
    if (!m[k]) m[k] = { id: k, nombre: label(p), ang: p.angulo, sec: "—", split: "100/0", hook: p.concepto, fmt: p.formato, spend: 0, revenue: 0, ventas: 0, conversaciones: 0, placements: 0, activos: 0, audSpend: {}, tipoSpend: {}, bk: {} };
    const g = m[k];
