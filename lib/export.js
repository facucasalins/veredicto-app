...
const HEADERS = {
  ...
  anuncio:  [...BASE, "campana", "campaign_id", "conjunto", "adset_id", "anuncio", "fingerprint", "fecha", "concepto", "angulo", "formato", "ad_id", "estado", "audiencia", "etapa_embudo", "tipo", ...MH, "alcance", "frecuencia", "calidad", "tasa_interaccion", "tasa_conversion"],
};
...
function filasCuenta(ads, nivel, maps = {}, meta = {}) {
  ...
  return enriched.map((a) => { const n = nomenclatura(a.name, plataforma); return [...base, a.campaign, a.campaign_id, a.adset, a.adset_id, a.name, n.fingerprint, n.fecha, n.concepto, n.angulo, n.formato, a.id, estadoTxt(a._estado), a._aud, etapaTxt(a._aud), a._tipo,
    ...MV(a), int(a.reach), dec(a.frequency, 1), a.calidad || "", a.interaccion || "", a.conversion || ""]; });
}
